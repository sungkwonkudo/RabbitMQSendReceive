...
public class MessagingApplication implements RabbitListenerConfigurer {
	...
	public static final String EXCHANGE_NAME = "kudo.test";
	public static final String QUEUE_GENERIC_NAME = "kudo.test.fun";
	public static final String QUEUE_SPECIFIC_NAME = "kudo.test.fun";
	public static final String ROUTING_KEY = "thisisabinding";
